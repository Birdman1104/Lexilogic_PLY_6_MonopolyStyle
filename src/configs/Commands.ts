...
export const onCardCheckMarkCompleteCommand = (uuid: string): void => Head.gameModel?.board?.processingCompleted(uuid);

const rightAnswerDetectedCommand = (): void => {
    lego.command
        //
        .execute(increaseRightAnswersCountCommand)
...
export const onWrongsUpdateCommand = (): void => {
    lego.command
        //
        .guard(wrongsCountReached)
        .execute(showCtaCommand);
};

export const onRightsUpdateCommand = (): void => {
    lego.command.guard(rightsCountReached).execute(showCtaCommand);
};
...
export const onBoardPointerDownCommand = (): void => {
    lego.command
        //
        .guard(hintModelGuard)
        .execute(hideHintCommand)
...
export const onBoardPointerUpCommand = (): void => {
    lego.command
        //
        .guard(hintModelGuard)
        .execute(startHintVisibilityTimerCommand);
